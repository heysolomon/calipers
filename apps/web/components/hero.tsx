...
const SPRING_SETTLE = { type: 'spring' as const, stiffness: 300, damping: 30 };
const SPRING_BOUNCE = { type: 'spring' as const, stiffness: 400, damping: 20 };
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <motion.div
          ...
          transition={{ ...SPRING_SETTLE, delay: reduceMotion ? 0 : 0.1 }}
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ ...SPRING_SETTLE, delay: reduceMotion ? 0 : 0.2 }}
        ...
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ ...SPRING_SETTLE, delay: reduceMotion ? 0 : 0.35 }}
          className="text-lg sm:text-xl max-w-xl mx-auto mb-10 leading-relaxed"
          style={{ color: 'rgba(255,255,255,0.5)', textWrap: 'pretty' }}
        >
        ...
        <motion.div
          initial={reduceMotion ? false : { opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ ...SPRING_BOUNCE, delay: reduceMotion ? 0 : 0.5 }}
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-3 rounded-lg font-medium text-sm site-link"
            style={{
        ...
        <motion.div
          ...
          transition={{ ...SPRING_SETTLE, delay: reduceMotion ? 0 : 0.7 }}
