...
export type DemoKey = 'inspect' | 'boxmodel' | 'measure' | 'guides';
...
const OFF = { inspect: false, boxmodel: false, measure: false, guides: false };
...
export function DemoProvider({ children }: { children: React.ReactNode }) {
  ...
  const anyTool = tools.inspect || tools.boxmodel || tools.measure || tools.guides;
